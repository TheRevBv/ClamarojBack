...
using ClamarojBack.Data;
using ClamarojBack.Models.Requests;
using ClamarojBack.Models.Responses;
using global::ApiWithAuth;
...
public class AuthController : ControllerBase
{
    ...
    [HttpPost]
    [Route("login")]
    public async Task<ActionResult<AuthReponse>> Login(AuthRequest request)  
    {
        if (!ModelState.IsValid)
        {
            return BadRequest(ModelState);
        ...
        return Ok(new ClamarojBack.Models.Responses.AuthReponse
        {
